...
<section className="rounded-b-full bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-sky-400 to-indigo-900 dark:bg-gray-900 drop-shadow-2xl">
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-xl">Whalepoint aims to raise funds to facilitate the protection and surveillance of marine wildlife using new blockchain technologies for greater future benefit..</p>
...
<br/>
  ...
  <br/>
    ...
    <div className=" grid grid-cols-3 gap-2 place-items-center">
            ...
            <div>
                <img className="h-auto max-w-xs rounded-lg hover:drop-shadow-2xl" src="/image/NFT2.jpeg" alt=""/>
            ...
            <div>
                <img className="h-auto max-w-sm rounded-lg hover:drop-shadow-2xl" src="/image/NFT1.jpeg" alt=""/>
                <h3 className="text-center mb-2 text-2xl font-bold tracking-tight  text-white">100 SOL Unic!</h3>
            </div>          
      
            <div>
                <img className="h-auto max-w-xs rounded-lg hover:drop-shadow-2xl" src="/image/NFT3.jpeg" alt=""/>
  ...
  <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl hover:drop-shadow-2xl">
    ...
    <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl hover:drop-shadow-2xl">
      ...
      <div className="flex flex-col justify-between py-20 pl-10 md:py-[68px] bg-gray-950 leading-normal">
          ...
          <img className="object-cover w-full h-96 md:h-auto md:w-96 md:rounded-r-lg" src="/image/ballena2.jpeg" alt=""/>
    </a>
    <br/>
    <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl hover:drop-shadow-2xl">
      <img className="object-cover w-full h-[15.5rem] md:w-96 md:rounded-l-lg" src="/image/ballena3.jpg"/>
