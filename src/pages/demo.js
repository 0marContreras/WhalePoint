...
<>
<Navbar/>
<section className="rounded-b-full bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-sky-400 to-indigo-900 dark:bg-gray-900">
...
<br/>
  ...
  <br/>
    ...
    <div className=" grid grid-cols-3 gap-2 place-items-center">
            ...
            <div>
                <img className="h-auto max-w-xs rounded-lg" src="/image/NFT2.jpeg" alt=""/>
                <h3 className="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white ">50 SOL Unic!</h3>
            </div>
            
      
      
            <div>
                <img className="h-auto max-w-sm rounded-lg" src="/image/NFT1.jpeg" alt=""/>
                <h3 className="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">100 SOL Unic!</h3>
            </div>          
      
            <div>
                <img className="h-auto max-w-xs rounded-lg" src="/image/NFT3.jpeg" alt=""/>
                <h3 className="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">25 SOL Unic!</h3>
            </div>
  ...
  <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl ">
      <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-l-lg" src="/image/ballena.jpeg" alt=""/>
    ...
    <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl">
      ...
      <div className="flex flex-col justify-between py-20 pl-10 bg-gray-950 leading-normal">
          ...
          <img className="object-cover w-full rounded-s-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-s-lg" src="/image/ballena2.jpeg" alt=""/>
    </a>
    <br/>
    <a href="#" className="ml-4 mr-4  p-10 md:space-y-0  md:flex md:items-center rounded-xl">
      <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-l-lg" src="/image/ballena3.jpg" alt=""/>
      <div className="flex flex-col justify-between py-20 pl-10 bg-gray-950 leading-normal">
  ...
  <footer class=" shadow bg-gray-950 ">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <Image src={require('../../public/logo.jpg')} className="h-8 w-8 mr-3 rounded-xl" alt="Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Whale Point</span>
            </a>
        ...
        <span class="block text-sm sm:text-center text-gray-400"><a href="/demo" class="hover:underline">We need your help,</a> They need your help</span>
    </div>
</footer>
